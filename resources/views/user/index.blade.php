    ...
    <div class="row">
      ...
      <div class=" col-sm-12 col-md-4 col-lg-4 my-2 ">
        <div class="shadow-div text-center info-h my-4 ">
          <div class="">
            <img class="img-circle my-2" src="images/slider3.jpg" height="40px" width="40px" alt="" />
            <p class="text-center info-color my-4">
              <span class="h4">Cardiology </span><br />
              <span>Qui laudantium consequatur laborum sit qui ad sapiente
              </span>
            </p>
          </div>
        </div>
      ...
      <div class=" col-sm-12 col-md-4 col-lg-4 my-2 ">
        <div class="shadow-div text-center info-h my-4 ">
          <div class="">
            <img class="img-circle my-2" src="images/slider2.jpg" height="40px" width="40px" alt="" />
            <p class="text-center info-color my-4">
              <span class="h4">Cardiology </span><br />
              <span>Qui laudantium consequatur laborum sit qui ad sapiente
              </span>
      ...
      <div class=" col-sm-12 col-md-4 col-lg-4 my-2 ">
        <div class="shadow-div text-center info-h my-4 ">
          <div class="">
            <img class="img-circle my-2" src="images/doctor5.jpg" height="40px" width="40px" alt="" />
            <p class="text-center info-color my-4">
              <span class="h4">Cardiology </span><br />
              <span>Qui laudantium consequatur laborum sit qui ad sapiente
              </span>
      ...
      <div class=" col-sm-12 col-md-4 col-lg-4 my-2 ">
        <div class="shadow-div text-center info-h my-4 ">
          <div class="">
            <img class="img-circle my-2" src="images/doctor2.jpg" height="40px" width="40px" alt="" />
            <p class="text-center info-color my-4">
              <span class="h4">Cardiology </span><br />
              <span>Qui laudantium consequatur laborum sit qui ad sapiente
              </span>
      ...
      <div class=" col-sm-12 col-md-4 col-lg-4 my-2 ">
        <div class="shadow-div text-center info-h my-4 ">
          <div class="">
            <img class="img-circle my-2" src="images/doctor1.jpg" height="40px" width="40px" alt="" />
            <p class="text-center info-color my-4">
              <span class="h4">Cardiology </span><br />
              <span>Qui laudantium consequatur laborum sit qui ad sapiente
              </span>
                  ...
                  <div class="d-flex flex-md-row px-3 mt-4 flex-column-reverse">
                    <div class="col-md-6">
                      <div class="card1">
                        ...
                        <h6 class="mb-5">Choice Doctor and time.</h6>
                        <h6 class="mb-5">Notes.</h6>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="card2 first-screen show ml-2">
                        ...
                        <div class="row px-3 mt-4">
                          <div class="form-group mt-1 mb-1">
                            ...
                            <input type="text" id="email" class="form-control" placeholder="Full Name" required>
                            <label class="ml-3" for="email">Phone</label>
                            <input type="text" id="email" class="form-control" placeholder="Phone" required>
                            ...
                            <input type="text" id="email" class="form-control" placeholder="Age" required>
                          </div>
                        ...
                        <div class="row px-3 mt-3">
                          <div class="form-group mt-1 mb-1">
                            ...
                            <select name="account" class="form-control">
                              ...
                              <option>D. Mahbubur Rahman</option>
                              <option>D. Pan Ghupal</option>
                              <option>D. Adiba</option>
                            </select>
                      ...
                      <div class="card2 ml-2">
                        <div class="row px-3 mt-5 mb-5 text-center">
                          ...
                          <div class="col-12 text-center"><img class="tick" src="images/doctor4.jpg"></div>
    ...
    <section class="">
      <div class="row">
        <div class="col-md-6 col-sm-12 col-lg-6 my-3">
          <div class="doctor container row my-3">
            <div class="col-md-4 my-3">
              <img class="doctor-image" src="images/doctor1.jpg" alt="" />
            </div>
            <div class="col-md-8 my-3">
              <div>
                <h4>MD Ratul Ahmed</h4>
                <span>Chief Medical Officer</span>
              </div>
              <hr />
              <span>Explicabo voluptatem mollitia et repellat qui dolorum
                quasi</span>
              <p class="form-inline">
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 my-3">
          <div class="doctor container row my-3">
            <div class="col-md-4 my-3">
              <img class="doctor-image" src="images/doctor2.jpg" alt="" />
            </div>
            <div class="col-md-8 my-3">
              <div>
                <h4>MD Ratul Ahmed</h4>
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 my-3">
          <div class="doctor container row my-3">
            <div class="col-md-4 my-3">
              <img class="doctor-image" src="images/doctor3.jpg" alt="" />
            </div>
            <div class="col-md-8 my-3">
              <div>
                <h4>MD Ratul Ahmed</h4>
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 my-3">
          <div class="doctor container row my-3">
            <div class="col-md-4 my-3">
              <img class="doctor-image" src="images/doctor4.jpg" alt="" />
            </div>
            <div class="col-md-8 my-3">
              <div>
                <h4>MD Ratul Ahmed</h4>
        ...
        <div class="col-md-6 col-sm-12 col-lg-6 my-3">
          <div class="doctor container row my-3">
            <div class="col-md-4 my-3">
              <img class="doctor-image" src="images/doctor5.jpg" alt="" />
            </div>
            <div class="col-md-8 my-3">
              <div>
                <h4>MD Ratul Ahmed</h4>
    ...
    <div class="row">
      ...
      <div class="col-md-4 col-sm-12 col-lg-4 my-2">
        <figure class="snip1527">
          <div class="image"><img height="310px" src="images/doctor1.jpg" alt="pr-sample23" /></div>
          <figcaption>
      ...
      <div class="col-md-4 col-sm-12 col-lg-4 my-2">
        <figure class="snip1527 hover">
          <div class="image"><img height="310px" src="images/doctor2.jpg" alt="pr-sample24" /></div>
          <figcaption>
      ...
      <div class="col-md-4 col-sm-12 col-lg-4 my-2">
        <figure class="snip1527">
          <div class="image"><img height="310px" src="images/doctor3.jpg" alt="pr-sample25" /></div>
          <figcaption>
      ...
      <div class="col-md-4 col-sm-12 col-lg-4 my-2">
        <figure class="snip1527">
          <div class="image"><img height="310px" src="images/doctor4.jpg" alt="pr-sample25" /></div>
          <figcaption>
            <div class="date"><span class="day">01</span><span class="month">Dec</span></div>
            <h3>Google May Face Antitrust Case</h3>
            <p> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id
      ...
      <div class="col-md-4 col-sm-12 col-lg-4 my-2">
        <figure class="snip1527">
          <div class="image"><img height="310px" src="images/doctor1.jpg" alt="pr-sample25" /></div>
          <figcaption>
            <div class="date"><span class="day">01</span><span class="month">Dec</span></div>
            <h3>Google May Face Antitrust Case</h3>
            <p> Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id
